...
{
    register_fn(Shape::CIRCLE, Shape::CIRCLE, [](const Shape& shapeA, const Shape& shapeB, auto* res) {
    ...
    register_fn(Shape::CIRCLE, Shape::RECT, [](const Shape& shapeA, const Shape& shapeB, auto* res) {
        assert(shapeA.type == Shape::CIRCLE);
    ...
    register_fn(Shape::CIRCLE, Shape::POLYGON, [](const Shape& shapeA, const Shape& shapeB, auto* res) {
        assert(shapeA.type == Shape::CIRCLE);
    ...
    register_fn(Shape::RECT, Shape::RECT, [](const Shape& shapeA, const Shape& shapeB, auto* res) {
    ...
    register_fn(Shape::RECT, Shape::POLYGON, [](const Shape& shapeA, const Shape& shapeB, auto* res) {
        assert(shapeA.type == Shape::RECT);
        assert(shapeB.type == Shape::POLYGON);
    ...
    register_fn(Shape::POLYGON, Shape::POLYGON, [](const Shape& shapeA, const Shape& shapeB, auto* res) {
...
bool CollisionFns::check(const Shape& shapeA, const Shape& shapeB, Collision::CollisionResponse* res) const
{
